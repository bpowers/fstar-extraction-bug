...
let lemma_cons_snoc: 'Aa . 'Aa -> 'Aa FStar_Seq_Base.seq -> 'Aa -> Prims.unit
...
let rec lemma_seq_list_bij: 'Aa . 'Aa FStar_Seq_Base.seq -> Prims.unit =
  fun s  -> ()
let rec lemma_list_seq_bij: 'Aa . 'Aa Prims.list -> Prims.unit = fun l  -> ()
...
let cons_head_tail: 'Aa . 'Aa FStar_Seq_Base.seq -> Prims.unit = fun s  -> ()
let head_cons: 'Aa . 'Aa -> 'Aa FStar_Seq_Base.seq -> Prims.unit =
  fun x  -> fun s  -> ()
let suffix_of_tail: 'Aa . 'Aa FStar_Seq_Base.seq -> Prims.unit = fun s  -> ()
