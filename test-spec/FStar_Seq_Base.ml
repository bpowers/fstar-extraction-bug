...
let lemma_of_list_length: 'Aa . 'Aa seq -> 'Aa Prims.list -> Prims.unit =
  fun s  -> fun l  -> ()
let lemma_of_list: 'Aa . 'Aa seq -> 'Aa Prims.list -> Prims.nat -> Prims.unit
  = fun s  -> fun l  -> fun i  -> ()
let exFalso0: 'Aa . Prims.nat -> 'Aa =
  fun a128  -> (Obj.magic (fun n  -> ())) a128
let createEmpty: 'Aa . Prims.unit -> 'Aa seq = fun uu____424  -> MkSeq []
let lemma_empty: 'Aa . 'Aa seq -> Prims.unit = fun s  -> ()
...
let rec lemma_len_slice:
  ...
  fun s  -> fun i  -> fun j  -> ()
let rec lemma_index_create: 'Aa . Prims.nat -> 'Aa -> Prims.nat -> Prims.unit
  = fun n  -> fun v  -> fun i  -> ()
...
let rec lemma_index_app1: 'Aa . 'Aa seq -> 'Aa seq -> Prims.nat -> Prims.unit
  = fun s1  -> fun s2  -> fun i  -> ()
let rec lemma_index_app2: 'Aa . 'Aa seq -> 'Aa seq -> Prims.nat -> Prims.unit
  = fun s1  -> fun s2  -> fun i  -> ()
